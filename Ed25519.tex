...
\tightlist
\item
  Verifikation soll jedem möglich sein\footnote<.->{Hühnlein and Korte
    (2006)}
\end{itemize}
\end{frame}
...
\item
  Verfikationsprozess\footnote<.->{Katz et al. (1996)}
\end{enumerate}
\end{frame}
...
\item
  ...
  \end{itemize}
\item
  K\textsubscript{Pub} in öffentlichem Verzeichnis\footnote<.->{Hühnlein
    and Korte (2006)}
\end{itemize}
\end{frame}
...
\item
  ...
  \pause
\item
  Speicherverbrauch, Energieverbrauch (IoT)(Hühnlein and Korte 2006)
\end{itemize}
\end{frame}
...
\tightlist
\item
  Verwendung\footnote<.->{Susella (2018)}
...
\begin{frame}{Signatur mit Ed25519 (Funktionsweise)}
\protect\hypertarget{signatur-mit-ed25519-funktionsweise}{}
\textbf{Tafelbild}
\end{frame}
...
\item
  ...
  \end{itemize}
\item
  Auxiliary Schlüssel b\footnote<.->{Susella (2018)}
\end{itemize}
...
\begin{itemize}
\item
  Wörter 0-3 = Private Auxillary Key (\textbf{b})
\item
  Wörter 4-15 = Message\footnote<.->{Susella (2018)}
\end{itemize}
